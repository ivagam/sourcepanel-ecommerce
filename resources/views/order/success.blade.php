...
<body>
    ...
    <div class="card p-5 shadow-sm radius-12">
        <div class="card-body">
            @if(session('message'))
                <div class="alert alert-{{ session('message.type') == 'success' ? 'success' : 'danger' }} text-center">
                    <h2 class="mb-3 text-center">{{ session('message.text') }}</h2>
                </div>
                    @if(session('message.type') == 'success')
                        <p class="fs-5 mb-4">Thank you for shopping with us. We’ve received your order and it’s being processed.</p>
                    @else
                        <p class="fs-5 mb-4">There was an issue with your order. Please try again or contact support.</p>
                    @endif
                
            @endif
            
            <a href="https://wa.me/919876543210" class="btn btn-success btn-lg mb-3" target="_blank">
                💬 Contact Us on WhatsApp
            </a>

            <p class="text-muted">Need help? Reach us at <a href="mailto:support@example.com">support@example.com</a></p>
