...
<head>
    ...
    <style>
        /* Styles to ensure logo fixed right and content padded */
        .bottom {
            position: relative;
                                ...
                                <div class="bottom">
                                    <div class="content">
                                        ...
                                        <a href="{{ env('SOURCE_PANEL_ECOMMERCE_URL') }}/product/{{ $product->product_url }}" 
                                           ...
                                           target="_blank"
                                           style="display: flex; align-items: center;">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="#262626" viewBox="0 0 24 24">
                                    ...
                                    <div class="logo">
                                        <a href="{{ env('SOURCE_PANEL_ECOMMERCE_URL') }}" title="Go to Home">
                                            <img src="http://localhost:8080/sourcepanel-ecommerce/assets/images/logo.png" width="111" height="34" alt="Repladeez Logo" />
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    card.innerHTML = `
                        <div class="top">
                            <div class="userDetails">
                                ...
                                <div class="bottom" style="position: relative; padding-right: 140px; display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
                                    <div class="content" style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap; flex: 1;">
                                        ...
                                        <span style="color: #555;">
                                            ${product.category?.category_name || 'Unknown Category'} $${product.product_price || '0.00'}
                                        </span>
                                        ...
                                        <a href="{{ env('SOURCE_PANEL_ECOMMERCE_URL') }}/product/${product.product_url}" target="_blank" title="View Product" style="display: flex; align-items: center;">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="#262626" viewBox="0 0 24 24">
                                                <path d="M12 5c-7 0-11 7-11 7s4 7 11 7 11-7 11-7-4-7-11-7zm0 12c-2.8 0-5-2.2-5-5s2.2-5 
                                                         5-5 5 2.2 5 5-2.2 5-5 5zm0-8c-1.7 0-3 1.3-3 3s1.3 
                                                         3 3 3 3-1.3 3-3-1.3-3-3-3z"/>
                                    ...
                                    <div class="logo" style="position: absolute; right: 0; top: 50%; transform: translateY(-50%);">
                                        <a href="{{ env('SOURCE_PANEL_ECOMMERCE_URL') }}" title="Go to Home">
                                            <img src="http://localhost:8080/sourcepanel-ecommerce/assets/images/logo.png" width="111" height="34" alt="Repladeez Logo" />
                                        </a>
                                    </div>
