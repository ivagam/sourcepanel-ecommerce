							...
							<div class="dropdown-menu mobile-cart">
								...
								<div class="dropdownmenu-wrapper custom-scrollbar">
										...
										<div class="product">
											<div class="product-details">
												...
												<span class="cart-product-info">
													<span class="cart-product-qty">{{ $item['qty'] ?? 0 }}</span> × ${{ $item['price'] ?? 0 }}
												</span>
											</div>
											<figure class="product-image-container">
                                                <a href="{{ url('product/' . $item['id']) }}" class="product-image">
													...
													<img src="{{ asset('../source_panel/public/' . $filePath) }}" alt="product" width="80" height="80">
                                                </a>
									...
									<div class="dropdown-cart-total">
										...
										<span class="cart-total-price float-right">${{ number_format($globalCartTotal, 2) }}</span>
