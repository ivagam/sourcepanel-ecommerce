                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">                                    
                                    <ul class="submenu">
										...
										<li><a href="{{ env('SOURCE_PANEL_ECOMMERCE_URL') }}/Dolce+%26+Gabbana">DG (Dolce & Gabbana)</a></li>
										...
										<li><a href="{{ env('SOURCE_PANEL_ECOMMERCE_URL') }}/Dior">Dior (Christian Dior)</a></li>
										...
										<li><a href="{{ env('SOURCE_PANEL_ECOMMERCE_URL') }}/Gucci">Gucci (GG)</a></li>
